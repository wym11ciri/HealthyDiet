package com.zuoni.dialog.picker.pickerdialog;
...
import com.zuoni.dialog.picker.view.LoopView;
import com.zuoni.dialog.picker.mInterface.OnDoubleDataSelectedListener;
...
public class DataPickerDoubleDialog extends Dialog {
    ...
    //在create中给Dialog设置参数
    private void setParams(DataPickerDoubleDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final DataPickerDoubleDialog.Params params;

        //构造器的构造方法
        public Builder(Context context) {
            this.context = context;
            params = new DataPickerDoubleDialog.Params();
        }
