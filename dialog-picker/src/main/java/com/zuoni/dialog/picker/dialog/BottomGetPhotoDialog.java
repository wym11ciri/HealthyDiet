...
public class BottomGetPhotoDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public BottomGetPhotoDialog create() {
            final BottomGetPhotoDialog dialog = new BottomGetPhotoDialog(context, params.shadow ? R.style.Theme_Light_NoTitle_Dialog : R.style.Theme_Light_NoTitle_NoShadow_Dialog);
