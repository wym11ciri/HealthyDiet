package com.zuoni.dialog.picker;
...
public class DataPickerDialog2 extends Dialog {
    ...
    private void setParams(DataPickerDialog2.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final DataPickerDialog2.Params params;

        public Builder(Context context) {
            this.context = context;
            params = new DataPickerDialog2.Params();
        }
