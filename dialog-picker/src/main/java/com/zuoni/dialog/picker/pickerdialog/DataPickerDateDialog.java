...
import com.zuoni.dialog.picker.view.LoopListener;
...
public class DataPickerDateDialog extends Dialog {
    ...
    private void setParams(DataPickerDateDialog.Params params) {
        this.params = params;
    }
    ...
    public static class Builder {
        ...
        private final DataPickerDateDialog.Params params;

        public Builder(Context context) {
            this.context = context;
            params = new DataPickerDateDialog.Params();
        }
