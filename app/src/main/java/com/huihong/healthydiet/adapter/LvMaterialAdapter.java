...
public class LvMaterialAdapter extends BaseAdapter {
    private Context mContext;
    private List<String> mList;

    public LvMaterialAdapter(Context mContext, List<String> mList) {
    ...
    public View getView(int position, View mView, ViewGroup parent) {
        ...
        ViewHolder mHolder;
        if (mView == null) {
            mView = LayoutInflater.from(mContext).inflate(R.layout.lv_material_item, null);
