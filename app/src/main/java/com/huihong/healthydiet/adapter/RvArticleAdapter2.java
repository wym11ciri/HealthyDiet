...
public class RvArticleAdapter2 extends RecyclerView.Adapter<RvArticleAdapter2.RvArticleViewHolder> {


    private LayoutInflater mInflater;
    private Context mContext;
//    private List<SearchVagueRestaurant.ListData2Bean> mList;
    ...
    public RvArticleAdapter2(Context pContext) {
//        mList = pList;
        mContext = pContext;
