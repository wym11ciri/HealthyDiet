...
public class RvSearchResultRightAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
//                });
            ...
            case DIET_TAG:
                ...
                Glide
                        .with(mContext)
                        .load(mList01.get(position).getTitleImage())
                        .asBitmap()
                        .error(R.mipmap.error_photo)
...
//        holder.rvArticleTag.setAdapter(new RvTagAdapter(mContext, mList.get(position).getTags()));
                ...
                mHolder3.mHorizontalListView.setAdapter(new LvTagAdapter(mContext, mList01.get(position).getTags()));

                mHolder3.name.setText(mList01.get(position).getName());
                mHolder3.sales.setText(mList01.get(position).getSales() + "份");
                mHolder3.price.setText(mList01.get(position).getPrice() + "");
                mHolder3.Restaurant_Name.setText(mList01.get(position).getRestaurant_Name());
                mHolder3.Restaurant_Address.setText(mList01.get(position).getRestaurant_Address());
                ...
                mHolder3.layoutMain.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mIntent.putExtra("RecipeId", mList01.get(position).getId() + "");
                        mContext.startActivity(mIntent);
                    }
                });


                int percentage = mList01.get(position).getConstitutionPercentage();
